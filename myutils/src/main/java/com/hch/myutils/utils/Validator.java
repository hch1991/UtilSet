...
public class Validator {
    ...
    /**
     * 自定义校验
     * @param verificationStr  需校验的字符串
     * @param regular 校验正则
     * @return
     */
    public static boolean customValidator(String verificationStr, String regular){
        return Pattern.matches(regular, verificationStr);
    }
